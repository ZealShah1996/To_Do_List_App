 ...
 */
router.get('/:todolistid?', async function (req, res) {
  try {
...
if(req.params.todolistid>0){
data= await mongoService.findAll(modelName,{"is_active":true,"is_deleted":false,"id":req.params.todolistid},{"requiredFields":requiredFields});
}else{
